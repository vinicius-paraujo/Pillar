...
class LeasesValidationTest {
    ...
    void setUp() {
        ...
        LeaseService dummyService = new LeaseService() {
            ...
            @Override public boolean renew(Lease lease, Duration ttl, OwnerToken owner) { return false; }
            @Override public boolean release(Lease lease, OwnerToken owner) { return false; }
        };
    ...
    void testRenewValidation() {
        Lease dummyLease = new Lease(new ResourceKey("res"));
